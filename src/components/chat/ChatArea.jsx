...
const ChatArea = ({ selectedGroupId, groups, messages, handleReply, handleReaction, handleSendMessage, messageContent, setMessageContent, replyingTo, setReplyingTo, loading }) => (
